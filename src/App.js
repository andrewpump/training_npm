    ...
    <ThemeProvider theme={themeMode === "light" ? lightTheme : darkTheme}>
      <Box sx={{ height:"100%", display: "flex", flexDirection: "column", backgroundColor: "background.default" }}>
        <Container maxWidth="xl" sx={{ backgroundColor: "background.default" }}>
          <AppBar position='static' sx={{ backgroundColor: "background.default", boxShadow: 0, padding: "16px" }}>
            <Toolbar disableGutters >
              <Icon sx={{ height: "60px", width: "60px", paddingRight: "16px" }}>
                <img src={LayerLogo} alt="Layer Logo" />
              </Icon>
              <Typography component='div' variant='h1' color={"background.contrastText"} sx={{ flexGrow: 1 }}>
                <Box fontWeight='700' display='inline'>Layer</Box> Park
              </Typography>

              <CustomSwitch onChange={() => { dispatch(toggleTheme()) }} />
            </Toolbar>
          </AppBar>
        </Container>
