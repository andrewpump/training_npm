    ...
    return (
        <Box>
            ...
            <Typography variant='caption'>
                Navigate to transactions screen and filter transactions by amount larger than 10 and
                by enddate less than and equal to today
            </Typography>
        </Box>
    );
};
...
export function NavigationPlayground() {
    ...
    const setValue = useCallback((index) => dispatch(setTabIndex(index)), [dispatch]);
