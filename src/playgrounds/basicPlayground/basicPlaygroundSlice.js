...
// Selectors
export const selectBox1Height = (state) => state.basicPlayground.heightPercentage;
export const selectBox2Height = (state) => (1 - state.basicPlayground.heightPercentage / 100) * 100;
export const selectProgressValue = (state) => state.basicPlayground.progressValue;
export const selectBox1BackgroundColor = (state) => state.basicPlayground.box1BackgroundColor;
export const selectBox2BackgroundColor = (state) => state.basicPlayground.box2BackgroundColor;
export const selectUnsplashResponse = (state) => state.basicPlayground.unsplashResponse;
